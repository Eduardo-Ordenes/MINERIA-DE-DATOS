    ...
    <section id="herramientas" className="section">
      ...
      <div className="content-block" data-aos="fade-right">
        <div className="text-content" >
          ...
          <a href="https://orangedatamining.com/" target="_blank">Sitio Web</a>
          ...
          <a href="https://www.knime.com/" target="_blank">Sitio Web</a>
        </div>
      ...
      <div className="content-block reverse" data-aos="fade-left">
        <div className="text-content">
          ...
          <a href="https://docs.rapidminer.com/" target="_blank">Sitio Web</a>
          ...
          <a href="https://ml.cms.waikato.ac.nz/weka" target="_blank">Sitio Web</a>
        </div>
        <div className="image-content">
